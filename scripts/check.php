...
$assert(str_contains($homeBody, 'Conçu pour produire'), 'The French Silex value proposition is missing.');
$assert(str_contains($homeBody, '>Simplicité<') && str_contains($homeBody, '>Sécurité<') && str_contains($homeBody, '>Efficacité<'), 'The French homepage benefits are missing.');
$assert(str_contains($homeBody, 'Windows x64, macOS Apple Silicon et Linux x64'), 'The French desktop target promise is missing.');
...
$assert(str_contains($englishHomeBody, 'Built to ship'), 'The English Silex value proposition is missing.');
$assert(str_contains($englishHomeBody, '>Simplicity<') && str_contains($englishHomeBody, '>Safety<') && str_contains($englishHomeBody, '>Efficiency<'), 'The English homepage benefits are missing.');
$assert(str_contains($englishHomeBody, 'Windows x64, macOS on Apple Silicon, and Linux x64'), 'The English desktop target promise is missing.');
