...
$assert(str_contains($homeBody, 'Transformez une idée en programme natif sans casser votre élan.'), 'The French benefit-led hero introduction is missing.');
$assert(str_contains($homeBody, 'Élan préservé') && str_contains($homeBody, 'Code limpide') && str_contains($homeBody, 'Résultat concret'), 'The French homepage benefits are missing.');
...
$assert(str_contains($englishHomeBody, 'Turn an idea into a native program without losing momentum.'), 'The English benefit-led hero introduction is missing.');
$assert(str_contains($englishHomeBody, 'Keep momentum') && str_contains($englishHomeBody, 'Clear code') && str_contains($englishHomeBody, 'Tangible results'), 'The English homepage benefits are missing.');
