...
$assert(str_contains($homeBody, 'Moins de setup') && str_contains($homeBody, 'Code maintenable') && str_contains($homeBody, 'Trois OS'), 'The French homepage benefits are missing.');
...
$assert(str_contains($englishHomeBody, 'Less setup') && str_contains($englishHomeBody, 'Maintainable code') && str_contains($englishHomeBody, 'Three OSes'), 'The English homepage benefits are missing.');
